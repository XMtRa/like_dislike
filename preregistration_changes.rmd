...
Initially, we planned to exclude all participants who finished the questionnaire in less than 6 minutes. However, this would lead to the deletion of participants who provided answers that seemed perfectly fine. In conclusion, we relaxed the criterion to 3 minutes, which led to the exclusion of 27 participants. Results changed only marginally and do not hinge on exclusion (see additional analyses).
...
- Given that we found not apparent effects of the three websites on the privacy calculus, we did not test for indirect effects as proposed in the preregistration. 
- We additionally also controlled for education (we forgot to explicitly mention this control variable in the preregistration; results do not differ, but we think it should be included, which is why we did).
