...
Research is increasingly building on the privacy calculus model, which states that communication online can be explained by perceived risks and expected benefits [@bolUnderstandingEffectsPersonalization2018; @krasnovaOnlineSocialNetworks2010; @meierPrivacyCalculusRevisited2022].
...
Disclosing information can be risky, and if people with higher privacy needs and privacy concerns are less likely to communicate online [@baruhOnlinePrivacyConcerns2017; @krasnovaOnlineSocialNetworks2010; masurTransformativeNotHow2021; @meierPrivacyCalculusRevisited2022].
...
If users are more familiar, experienced, and knowledgeable in a given online context, they are more likely to navigate that online contexts successfully and to communicate actively [@baruhOnlinePrivacyConcerns2017; @kramerMasteringChallengeBalancing2020].
People with more privacy self-efficacy also engage more successfully in self-withdrawal [@dienlinExtendedPrivacyCalculus2016].
...
To exclude confounding influences, I controlled all variables for age, gender, and education, which have been shown to affect both privacy concerns and online communication [@tifferetGenderDifferencesPrivacy2019a].
